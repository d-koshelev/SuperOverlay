...
{
    private readonly ILayoutInteractionSession _session;
    ...
    public LayoutEditorInteractionController(ILayoutInteractionSession session, LayoutInteractionOptions? options = null)
    {
